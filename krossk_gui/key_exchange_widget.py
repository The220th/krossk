...
class KeyExchangeWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.__exchange_algo_label = QLabel("Exchange algorithm", self)
        self.__exchange_algo_label.setAlignment(QtCore.Qt.AlignRight | QtCore.Qt.AlignVCenter)

        self.__grid.addWidget(self.__exchange_algo_label, 0, 0, 1, 1)
        self.__grid.addWidget(self.__widgetsSelectCombo, 0, 1, 1, 1)
...
class one_KeyExchangeWidget(QWidget):
    ...
    def __init__(self, algo_num, parent):
        ...
        first_party_label, seconf_patry_laber = QLabel("The first party:", self), QLabel("The second party:", self)
        first_party_label.setAlignment(QtCore.Qt.AlignHCenter | QtCore.Qt.AlignVCenter)
        seconf_patry_laber.setAlignment(QtCore.Qt.AlignHCenter | QtCore.Qt.AlignVCenter)
        self.__grid.addWidget(first_party_label, 0, 0, 1, 1)
        self.__grid.addWidget(seconf_patry_laber, 0, 1, 1, 1)
        self.__gb1 = QGroupBox(self)
        self.__gb2 = QGroupBox(self)
        self.__gb1_l = QGridLayout(self.__gb1)
        self.__gb2_l = QGridLayout(self.__gb2)
        self.__gb1.setLayout(self.__gb1_l)
        self.__gb2.setLayout(self.__gb2_l)
        self.__grid.addWidget(self.__gb1, 1, 0, 1, 1)
        self.__grid.addWidget(self.__gb2, 1, 1, 1, 1)
        self.__grid.setRowStretch(1, 100)
        if(self.__algo_num == 1):
            self.__gb1_l.addWidget(QLabel("1. Generate keys:", self), 1, 0, 1, 1)
            self.__gb1_l.addWidget(self.__genKeys_button, 2, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("And send this public key to the second party:", self), 3, 0, 1, 1)
            self.__gb1_l.addWidget(self.__pubKey_text_out, 4, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 5, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 6, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 7, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 8, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 9, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 10, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("3. Get public key from the second party and paste:", self), 11, 0, 1, 1)
            self.__gb1_l.addWidget(self.__encrypted_key_text_in, 12, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("And decrypt:", self), 13, 0, 1, 1)
            self.__gb1_l.addWidget(self.__deKeys_button, 14, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("Use this shared passphrase:", self), 15, 0, 1, 1)
            self.__gb1_l.addWidget(self.__key_text_out1, 16, 0, 1, 1)

            self.__gb2_l.addWidget(QLabel("", self), 1, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 2, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 3, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 4, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("2. Get the public key from the first party and paste below:", self), 5, 0, 1, 1)
            self.__gb2_l.addWidget(self.__pubKey_text_in, 6, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("Then Generate keys:", self), 7, 0, 1, 1)
            self.__gb2_l.addWidget(self.__encrypt_button, 8, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("And send this public key to the first party:", self), 9, 0, 1, 1)
            self.__gb2_l.addWidget(self.__encrypted_key_text_out, 10, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 11, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 12, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 13, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 14, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("Use this shared passphrase:", self), 15, 0, 1, 1)
            self.__gb2_l.addWidget(self.__key_text_out2, 16, 0, 1, 1)
        elif(self.__algo_num == 2):
            self.__gb1_l.addWidget(QLabel("1. Generate keys:", self), 1, 0, 1, 1)
            self.__gb1_l.addWidget(self.__genKeys_button, 2, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("And send this public key to the second party:", self), 3, 0, 1, 1)
            ...
            self.__gb1_l.addWidget(QLabel("", self), 9, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 10, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 11, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("", self), 12, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("3. Get encrypted passphrase from the second party:", self), 13, 0, 1, 1)
            self.__gb1_l.addWidget(self.__encrypted_key_text_in, 14, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("And calculate shared passphrase:", self), 15, 0, 1, 1)
            self.__gb1_l.addWidget(self.__deKeys_button, 16, 0, 1, 1)
            self.__gb1_l.addWidget(QLabel("Use this shared passphrase:", self), 17, 0, 1, 1)
            self.__gb1_l.addWidget(self.__key_text_out1, 18, 0, 1, 1)

            self.__gb2_l.addWidget(QLabel("", self), 1, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 2, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 3, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 4, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("2. Input generator of shared passphrase: ", self), 5, 0, 1, 1)
            self.__gb2_l.addWidget(self.__key_text_in, 6, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("Next get the public key from the first party and paste:", self), 7, 0, 1, 1)
            self.__gb2_l.addWidget(self.__pubKey_text_in, 8, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("Then encrypt:", self), 9, 0, 1, 1)
            self.__gb2_l.addWidget(self.__encrypt_button, 10, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("And send this encrypted passphrase to the first party:", self), 11, 0, 1, 1)
            self.__gb2_l.addWidget(self.__encrypted_key_text_out, 12, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 13, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 14, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("", self), 15, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("This shared passphrase below must be got by the first party.", self), 16, 0, 1, 1)
            self.__gb2_l.addWidget(QLabel("Use this shared passphrase:", self), 17, 0, 1, 1)
            self.__gb2_l.addWidget(self.__key_text_out2, 18, 0, 1, 1)
        else:
            ifMsg(self, "Failed successfully", 4)
    ...
    def __genKeys_button_handler(self):
        if(self.__algo_num == 1):
            ...
            ifMsg(self, "It may take some time (a few minutes?)", 2)
