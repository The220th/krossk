...
class KeyExchangeWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.__grid.addWidget(QLabel("", self), 13, 0, 1, 1)
        self.__grid.addWidget(QLabel("", self), 14, 0, 1, 1)
        self.__grid.addWidget(QLabel("1.3. Get encrypted passphrase from the second party:", self), 15, 0, 1, 1)
        self.__grid.addWidget(self.__encrypted_key_text_in, 16, 0, 1, 1)
        self.__grid.addWidget(QLabel("1.4. Decrypt:", self), 17, 0, 1, 1)
        self.__grid.addWidget(self.__deKeys_button, 18, 0, 1, 1)
        self.__grid.addWidget(QLabel("Use this shared passphrase:", self), 19, 0, 1, 1)
        self.__grid.addWidget(self.__key_text_out1, 20, 0, 1, 1)
        ...
        self.__grid.addWidget(QLabel("This shared passphrase must be got by the first party:", self), 11, 1, 1, 1)
        self.__grid.addWidget(self.__encrypted_shakey_text_out, 12, 1, 1, 1)
        self.__grid.addWidget(QLabel("2.4. Send this encrypted passphrase to the first party:", self), 13, 1, 1, 1)
        self.__grid.addWidget(self.__encrypted_key_text_out, 14, 1, 1, 1)
        self.__grid.addWidget(QLabel("", self), 15, 1, 1, 1)
        self.__grid.addWidget(QLabel("", self), 16, 1, 1, 1)
        self.__grid.addWidget(QLabel("", self), 17, 1, 1, 1)
        self.__grid.addWidget(QLabel("", self), 18, 1, 1, 1)
        self.__grid.addWidget(QLabel("Use this shared passphrase:", self), 19, 1, 1, 1)
        self.__grid.addWidget(self.__key_text_out2, 20, 1, 1, 1)
